...
<% response.setDateHeader("Expires",System.currentTimeMillis());
   ...
   %>
<FORM method="POST" action="institutionSelectionError.jsp">
	...
	<TABLE border="0" align="center" cellspacing="5" cellpadding="5" width="95%">
		<TR>
			...
			<%if(thePage != null){
			    ...
			    <H2 class ="title">Either the patient did or institution selection is incorrect.
			<%  }
			    else{%>
			   <H2 class ="title">Either the patient did or institution selection is incorrect.
			<% }
	  ...
	  if(thePage != null){	    
	    ...
	    if(id==null || id.equals("")){		 
	      ...
	      <%}
		   ...
		   destination = thePage+"?id="+id+"&status3=true";				      
		   %>
		   <jsp:forward page="<%=destination%>"/>	
		<%}
	    }
